...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init(); // first main page mini slider
  ...
  showUpSlider.init(); // third main page mini slider
  ...
  moduleSlider.init(); // fifth main page mini slider
  ...
  feedSlider.init(); //Diference

  new _modules_diference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init(); // Form

  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init(); // second page  module slider

  var modulePageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  modulePageSlider.render(); // Show Info

  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content').init(); // Download

  new _modules_slider_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init();
});
...
/*#__PURE__*/
function () {
  function Diference(oldDiference, newDiference, items) {
    _classCallCheck(this, Diference);
  ...
  _createClass(Diference, [{
    key: "bindTriggers",
    value: function bindTriggers(container, propsCounter, propsItems) {
...
function () {
  ...
  _createClass(ShowInfo, [{
    key: "hideTriggers",
    value: function hideTriggers() {
      this.btnPlus.forEach(function (item) {
        item.style.display = "none";
      });
      this.btnMinus.forEach(function (item) {
        item.style.display = "block";
      });
      this.infoBlock.forEach(function (item) {
        item.classList.add("animated", "fadeInDown");
      });
    }
  }, {
    key: "showTriggers",
    value: function showTriggers() {
      this.btnPlus.forEach(function (item) {
        item.style.display = "block";
      });
      this.btnMinus.forEach(function (item) {
...
function () {
  ...
  _createClass(Download, [{
    key: "dowloadItem",
    value: function dowloadItem(path) {
...
function _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }
 ...
 // слайд первой страницы - главный слайд
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, autoplay, animate, paused) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, autoplay, animate, paused));
  }
      ...
      this.prev.addEventListener("click", function () {
        ...
        for (var i = _this.slides.length - 1; i > 0; i--) {
          if (_this.slides[i].tagName !== "BUTTON") {
            ...
            var active = _this.slides[i]; //последний слайд поместить перед первым - то есть в начало слайдов
